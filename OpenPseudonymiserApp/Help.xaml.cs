...
namespace OpenPseudonymiser
{
    ...
    {
        private MainWindow_TNG.Page currentPage;


        public Help(MainWindow_TNG.Page currentPage)
        {            
            ...
            switch (currentPage)
            {
                ...
                case MainWindow_TNG.Page.ChooseSource:
                    textBlock1.Text = OpenPResources.HelpText_General;
                    break;

                case MainWindow_TNG.Page.ChooseSalt:
                    textBlock1.Text = OpenPResources.HelpText_Salt;
                    break;

                case MainWindow_TNG.Page.ChooseColumns:
                    textBlock1.Text = OpenPResources.HelpText_Columns;
                    break;

                case MainWindow_TNG.Page.ChooseTarget:
                    textBlock1.Text = OpenPResources.HelpText_Target;
                    break;
            }
